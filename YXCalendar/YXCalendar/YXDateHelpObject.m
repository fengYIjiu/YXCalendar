...
/** 判断两日期大小
 oneDay>anotherDay : YES
 oneDay<=anotherDay : NO
 */
...
// 判断两个月的大小
- (BOOL)compareOneMonth:(NSDate *)oneMonth withAnotherMonth:(NSDate *)anotherMonth
{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:@"MM-yyyy"];
    NSString *oneDayStr = [dateFormatter stringFromDate:oneMonth];
    NSString *anotherDayStr = [dateFormatter stringFromDate:anotherMonth];
    NSDate *dateA = [dateFormatter dateFromString:oneDayStr];
    NSDate *dateB = [dateFormatter dateFromString:anotherDayStr];
    NSComparisonResult result = [dateA compare:dateB];
